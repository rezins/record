...
public class RecordPlugin implements FlutterPlugin, ActivityAware {
  ...
  public void onAttachedToActivity(@NonNull ActivityPluginBinding binding) {
    ...
    startPlugin(pluginBinding.getBinaryMessenger(), binding, pluginBinding.getApplicationContext());
  }
  ...
  private void startPlugin(BinaryMessenger messenger, ActivityPluginBinding binding, Context context) {

    handler = new MethodCallHandlerImpl(binding.getActivity(), context);
